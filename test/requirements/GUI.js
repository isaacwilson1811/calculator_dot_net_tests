...
class GUI {
    'Design Requirements' = {
        visuals: { approvedColors: { accentText: {'Silian Grail': '#003366'}, borders: {'Eggshell': '#bbbbbb' }, backgrounds: { 'Bone': '#eeeeee', 'Go Money Green': '#4c7b25', 'Luxurious Granite': '#444444', 'Mistake Grey': '#ababab' } },
